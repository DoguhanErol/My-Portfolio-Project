...
const ProjectDetailsPage: React.FC = () => {
    ...
    //Querys
    const projectData = useQuery<IProjectDetail, Error, IProjectDetail, ["projectDetail"]>({
    ...
    //Types daki Iproject i iki farkli yerde kullanmaya calistigindan olabliri
                ...
                <article className='flex flex-col  rounded-md w-[95%] shadow-2xl h-auto z-20 bg-slate-950 bg-opacity-80 animate-[backInDown_0.8s_ease] my-3'>
                    <section className='flex flex-col  text-xl md:text-3xl  w-full '>
                        <article className='flex flex-row bg-slate-600 w-full'>
                            <h2 className='text-[#b4d7d9] ml-3'>Proje Adi: <span className='ml-2 text-[#94B0B2]'>{projectData.data.project.project_name}</span></h2>
                        </article>

                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3'>Proje Turu: <span className='ml-2 text-[#94B0B2]'>{projectData.data.project.project_type}</span></h2>
                        </article>

                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3 '>Proje Icerigi: <span className='ml-2 text-[#94B0B2]'>{projectData.data.project.project_type}</span></h2>
                        </article>

                        <article className='flex flex-row'>
                            <h2 className='text-[#b4d7d9] ml-3'>Proje Butcesi: <span className='ml-2 text-[#94B0B2]'>{projectData.data.project.project_budget}</span></h2>
                        </article>

                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3'>Proje Teslim Tarihi: <span className='ml-2 text-[#94B0B2]'></span></h2>
                            <p className='ml-2'>{projectData.data.project.project_delivery_date}</p>
                        </article>

                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3'>Projede Kullanılan Front-End Teknolojiler: <span className='text-[#94B0B2]'>{projectData.data.project.project_frontend_tecnologies}</span></h2>
                        </article>

                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3'>Projede Kullanılan Back-End Teknolojiler: <span className='text-[#94B0B2]'>{projectData.data.project.project_backend_tecnologies}</span></h2>
                        </article>


                        <article className='flex flex-row '>
                            <h2 className='text-[#b4d7d9] ml-3'>Projede Detayları: <span className='text-[#94B0B2]'>{projectData.data.project.project_details}</span></h2>
                        </article>

                        <article className='flex justify-center items-center md:justify-end md:items-end m-4  md:m-6 h-full text-2xl md:text-3xl'>
                            <a href={'' + projectData.data.project.project_live_url} className='px-2 md:px-5 py-1  font-medium border rounded text-[#b4d7d9] ml-3 md:ml-6 hover:text-[#cdf9fc] w-auto h-auto hover:scale-105'>Projeye Git</a>
                            <a href={'' + projectData.data.project.project_github_url} className='px-2 md:px-5 py-1  font-medium border rounded text-[#b4d7d9] ml-3 md:ml-6 hover:text-[#cdf9fc] w-auto h-auto hover:scale-105'>Proje Koduna Git</a>
                        </article>
