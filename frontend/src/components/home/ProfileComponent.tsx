...
export default function ProfileComponent() {
  ...
  return (
    <>
        <div className="flex flex-col w-[90%] justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 bg-opacity-80 text-gray-100">
        	<img src={myImage} alt="My Picture" className="w-28 h-36 object-center mx-auto rounded-full dark:bg-gray-500 " />
        	<div className="space-y-4 text-center divide-y divide-gray-700">
        		<div className="my-2 space-y-1">
        			<h2 className="text-2xl font-semibold">Leroy Jenkins</h2>
        			<p className="px-5 text-xl  dark:text-gray-400">Full-stack developer</p>
        		</div>
