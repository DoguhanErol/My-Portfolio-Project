...
const ProjectCarousel:React.FC<TProps> = (props:TProps) => {
  ...
  //Checks
  if (projectImagesData.isLoading || projectImagesData.isRefetching || !props.project.project_image_path) {
    console.log('Loading...');
  ...
  return (
    <>
        <figure className='max-w-3xl h-auto'>
            <img src={ globalVariables.baseUrlApi +props.project.project_image_path} alt="Project Image" className='h-full' />
        </figure>
        {/* Prev Button */}
