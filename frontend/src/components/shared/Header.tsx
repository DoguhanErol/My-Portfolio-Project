...
export default function Header() {
   ...
   // Use Effect to close menu on location change
   useEffect(() => {
       setIsVisible(false);
   }, [location.pathname]);
   ...
   // Function to close navigation on link click
   const handleLinkClick = () => {
       setIsVisible(false); // Close navigation
   };
                ...
                <section className='flex flex-row w-full justify-between bg-slate-900 z-30'>
                    ...
                    <article className='hidden sm:flex flex-row'>
                        <nav className='group  m-2 mr-8' >
                            <a href={globalVariables.adminLoginUrl} className='flex flex-row  hover:text-cyan-50 hover:scale-95 hover:border-gray-500 transition-all  text-cyan-400 text-3xl border border-gray-400 rounded-md  p-1'>
                ...
                <section style={{ display: isVisible === true ? 'flex' : 'none' }} className='flex sm:hidden w-full h-0 animate-[fadeInDownBig_0.6s] z-20'>
                    <div className='fixed flex flex-col z-30 text-4xl gap-3 h-auto pb-10 rounded-b-3xl w-full bg-[#334155da]'>
                        <article className='flex flex-row w-full items-center justify-center'>
                            <nav className='group m-2 mr-8'>
                                <a href={globalVariables.adminLoginUrl} className='flex flex-row hover:text-cyan-50 hover:scale-95 hover:border-gray-500 transition-all text-cyan-400 text-3xl border border-gray-400 rounded-md p-1' onClick={handleLinkClick}>
                                    <span className='mx-2 mt-[1px]'>Admin Girişi</span>
                                    <svg fill='currentColor' xmlns="http://www.w3.org/2000/svg" height="36" viewBox="0 -960 960 960" width="36"><path d="M234-276q51-39 114-61.5T480-360q69 0 132 22.5T726-276q35-41 54.5-93T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 59 19.5 111t54.5 93Zm246-164q-59 0-99.5-40.5T340-580q0-59 40.5-99.5T480-720q59 0 99.5 40.5T620-580q0 59-40.5 99.5T480-440Zm0 360q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q53 0 100-15.5t86-44.5q-39-29-86-44.5T480-280q-53 0-100 15.5T294-220q39 29 86 44.5T480-160Zm0-360q26 0 43-17t17-43q0-26-17-43t-43-17q-26 0-43 17t-17 43q0 26 17 43t43 17Zm0-60Zm0 360Z"/></svg>
                                </a>
                            </nav>
                        </article>
